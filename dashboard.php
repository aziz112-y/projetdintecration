                  ...
                  <div class="card bg-primary">
                    <div class="card-body row">
                      <div class="col-xxl-6">
                        ...
                        <h1 class="mt-3 mb-0 fw-bold text-white" id="totaltickets"></h1>
  ...
  <script>
    function loadmale() {
      return new Promise((resolve, reject) => {
        fetch("controller/dashboard/male.php")
    ...
    function loadfemale() {
      return new Promise((resolve, reject) => {
        fetch("controller/dashboard/female.php")
          .then(response => response.text())
          .then(data => {
            female = Number(data);
            resolve(); // Resolve the promise once data is loaded
          ...
          .catch(error => {
            console.error('Error loading female data:', error);
            reject(error); // Reject the promise if an error occurs
          });
      });
    }
