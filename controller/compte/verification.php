                    ...
                    <div class="row g-0">
                        <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center rounded-lg auth-h100">
                            <div style="max-width: 25rem;">
                                ...
                                <!-- Image block -->
                                <div class="">
                                    <img src="controller\compte\__ My-Task__ Two Step_files/login-img.svg" alt="login-img">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                                ...
                                <form class="row g-1 p-3 p-md-4">
                                    <div class="col-12 text-center mb-1 mb-lg-5">
                                        <img src="controller\compte\__ My-Task__ Two Step_files/verify.svg" class="w240 mb-4" alt="">
                                        <h1>Verification Avec Succees</h1>
                                    </div>
                                    <div>

                                    </div>
                                    <div class="col-12 text-center mt-4">
                                        <a href="login.php" title="" class="btn btn-lg btn-block btn-light lift text-uppercase">Login</a>
                                    </div>
                        ...
                        <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                            <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                                ...
                                <form class="row g-1 p-3 p-md-4">
                                    <div class="col-12 text-center mb-1 mb-lg-5">
                                        <img src="controller\compte\__ My-Task__ Two Step_files/verify.svg" class="w240 mb-4" alt="">
                                        <h1>Echec de Verification (lien invalide )</h1>
                                    </div>
                                    <div>
